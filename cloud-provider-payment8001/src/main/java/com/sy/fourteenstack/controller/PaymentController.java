...
import com.sy.fourteenstack.entities.CommonResult;
...
public class PaymentController {
    ...
    public CommonResult create(@RequestBody Payment payment){
        ...
        log.info("insert the result:" + result);
    ...
    public CommonResult getPaymentById(@PathVariable("id") Long id){
        ...
        log.info("insert the result:" + payment);

        if (payment != null) {
            return new CommonResult(200,"select successfully",payment);
        }else{
            return new CommonResult(444,"select error" + id,null);
        }
    }
